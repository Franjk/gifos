        ...
        <button class="gifo-button button-fav ${favoriteClass}">
          ...
          >
            ...
            >
              <g
                id="00-UI-Kit"
                transform="translate(-816.000000, -2777.000000)"
              >
                <g id="icon-fav" transform="translate(816.000000, 2777.000000)">
                  ...
                  ></rect>
                  <mask id="mask-2" fill="white">
                    <use xlink:href="#icon-fav-path-1"></use>
                  </mask>
                  <use
                    fill-opacity="1"
                    fill="#572EE5"
                    fill-rule="nonzero"
                    xlink:href="#icon-fav-path-1"
                  ></use>
                </g>
              </g>
            </g>
          ...
          >
            ...
            >
              <g
                ...
                transform="translate(-261.000000, -427.000000)"
              >
                <mask id="mask-2" fill="white">
                  <use xlink:href="#icon-fav-active-path-1"></use>
                </mask>
                <use
                  id="icon-fav-active"
                  fill="#572EE5"
                  fill-rule="nonzero"
                  xlink:href="#icon-fav-active-path-1"
                ></use>
              </g>
            </g>
          </svg>
        ...
        <a 
          ...
          >
            ...
            >
              <g
                id="00-UI-Kit"
                transform="translate(-816.000000, -2819.000000)"
              >
                <g
                  id="icon-download"
                  transform="translate(816.000000, 2819.000000)"
                >
                  ...
                  ></rect>
                  <mask id="mask-2" fill="white">
                    <use xlink:href="#icon-download-path-1"></use>
                  </mask>
                  <use
                    id="Combined-Shape"
                    fill-opacity="0.7"
                    fill="#572EE5"
                    fill-rule="nonzero"
                    xlink:href="#icon-download-path-1"
                  ></use>
                </g>
              </g>
            </g>
        ...
        <button class="gifo-button button-max">
          ...
          >
            ...
            >
              <g
                id="00-UI-Kit"
                transform="translate(-816.000000, -2861.000000)"
              >
                <g
                  id="icon-max-normal"
                  transform="translate(816.000000, 2861.000000)"
                >
                  ...
                  ></rect>
                  <mask id="mask-2" fill="white">
                    <use xlink:href="#icon-max-path-1"></use>
                  </mask>
                  <use
                    id="Combined-Shape"
                    fill-opacity="0.7"
